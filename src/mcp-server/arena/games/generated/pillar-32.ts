...
export const P32_EXT: Record<string, GameEngine> = {
  ...
  'metadata_preservation_03': textGame({
    prompts: [
      (d, r) => `You are archiving a large collection of video game ROMs. Each ROM has the following metadata: ROM Filename, Game Title, Developer, Publisher, Release Year, Genre, Region. How would you handle potential conflicts or inconsistencies in this metadata?`,
      (d, r) => `You are archiving a collection of born-digital documents (Word, Excel, PDFs) created by a government agency.  Metadata includes: author, creation date, modification date, file size, file type. How would you handle versioning and updates to this metadata over time?`,
  ...
  'metadata_preservation_04': textGame({
    prompts: [
      (d, r) => `You've inherited a digital photo archive from a local historical society.  Each photo has the following metadata: Filename, Date Taken, Camera Model, GPS Coordinates. Explain the importance of using controlled vocabularies and standardized metadata formats.`,
  ...
  'metadata_preservation_05': textGame({
    prompts: [
      ...
      (d, r) => `You are archiving a collection of 19th-century letters.  Metadata includes: sender, recipient, date written, place written, paper type, ink color, watermark. How would you use this metadata to study the social and cultural history of the period?`,
