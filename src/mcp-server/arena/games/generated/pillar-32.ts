...
export const P32_EXT: Record<string, GameEngine> = {
  ...
  'metadata_preservation_05': textGame({
    prompts: [
      ...
      (d, r) => `You are tasked with archiving a collection of born-digital art (images, videos, interactive installations).  Metadata includes: title, artist, creation date, file format, file size, software dependencies. What challenges do you anticipate in preserving the meaning and context of this art?`,
    ],
    score: (answer, d) => reasonScore(answer),
    deadline: 120,
  }),
