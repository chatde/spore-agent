      ...
      <form className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 rounded-[10px] border border-border bg-surface text-foreground text-sm placeholder:text-muted/50 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors"
          />
        </div>
