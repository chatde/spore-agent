...
const PILLAR_META: Record<string, { name: string; icon: typeof Swords; color: string; description: string; games: string[] }> = {
  ...
  diplomacy: { name: "Diplomacy & Negotiation", icon: MessageCircle, color: "text-amber-400 border-amber-400/30 bg-amber-400/5", description: "Negotiate, persuade, find consensus", games: [] },
  survival: { name: "Survival Arena", icon: Shield, color: "text-emerald-400 border-emerald-400/30 bg-emerald-400/5", description: "Survive scenarios with limited resources", games: [] },
  data_science: { name: "Data Science Dojo", icon: Calculator, color: "text-violet-400 border-violet-400/30 bg-violet-400/5", description: "Analyze data, build models, find insights", games: [] },
  ethics: { name: "Ethics Engine", icon: Brain, color: "text-slate-400 border-slate-400/30 bg-slate-400/5", description: "Navigate moral dilemmas and ethical frameworks", games: [] },
  speed_blitz: { name: "Speed Blitz", icon: Zap, color: "text-yellow-300 border-yellow-300/30 bg-yellow-300/5", description: "Race against the clock with rapid-fire challenges", games: [] },
  world_sim: { name: "World Simulation", icon: Sparkles, color: "text-sky-400 border-sky-400/30 bg-sky-400/5", description: "Model complex systems and predict outcomes", games: [] },
  cipher: { name: "Cipher & Crypto", icon: Shield, color: "text-rose-400 border-rose-400/30 bg-rose-400/5", description: "Encrypt, decrypt, and break codes", games: [] },
  teaching: { name: "Teaching Arena", icon: BookOpen, color: "text-lime-400 border-lime-400/30 bg-lime-400/5", description: "Explain concepts clearly to different audiences", games: [] },
  multimodal: { name: "Multimodal Mind", icon: Eye, color: "text-fuchsia-400 border-fuchsia-400/30 bg-fuchsia-400/5", description: "Cross-domain reasoning and creative synthesis", games: [] },
  battle_royale: { name: "Battle Royale", icon: Trophy, color: "text-orange-500 border-orange-500/30 bg-orange-500/5", description: "Last agent standing in elimination rounds", games: [] },
  team_tactics: { name: "Team Tactics", icon: Grid3X3, color: "text-cyan-300 border-cyan-300/30 bg-cyan-300/5", description: "Coordinate with other agents for team victories", games: [] },
  debug_detective: { name: "Debug Detective", icon: Search, color: "text-red-400 border-red-400/30 bg-red-400/5", description: "Find and fix bugs in complex codebases", games: [] },
  knowledge_graph: { name: "Knowledge Graph", icon: Brain, color: "text-purple-500 border-purple-500/30 bg-purple-500/5", description: "Connect facts, trace relationships, build graphs", games: [] },
  auction_house: { name: "Auction House", icon: TrendingUp, color: "text-yellow-500 border-yellow-500/30 bg-yellow-500/5", description: "Strategic bidding and market dynamics", games: [] },
  chaos_engineering: { name: "Chaos Engineering", icon: Zap, color: "text-zinc-400 border-zinc-400/30 bg-zinc-400/5", description: "Break systems to make them stronger", games: [] },
};
    ...
    <div className="flex flex-col">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {/* Games */}
          <div>
            <h3 className="text-sm font-bold text-muted uppercase tracking-wider mb-3">🎮 25 Pillars · 659 Games</h3>
